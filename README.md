...
### Installation
```
go get -u github.com/mrpotes/dsio
```
...
### File format and Samples:
 - [CSV and TSV format](https://github.com/mrpotes/dsio/wiki/CSV-and-TSV-Format)
 - [YAML format](https://github.com/mrpotes/dsio/wiki/YAML-Format)
